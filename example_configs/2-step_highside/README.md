...
In this split processing scenario, it will be necessary to transfer the python dependencies to the high side. Pay attention to the instructions under "Installation" in the main README.
