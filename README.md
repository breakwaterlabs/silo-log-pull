...
```
cd existing_repo
git remote add origin https://gitlab.com/breakwaterlabs/silo-log-pull.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/breakwaterlabs/silo-log-pull/-/settings/integrations)
